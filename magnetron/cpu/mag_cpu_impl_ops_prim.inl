...
#define mag_opf_mod(T, x, y) ((x)%(y))
#define mag_opf_fmod(T, x, y) (fmodf((x),(y)))
#define mag_opf_and(T, x, y) ((x)&(y))
#define mag_opf_or(T, x, y) ((x)|(y))
#define mag_opf_xor(T, x, y) ((x)^(y))
#define mag_opf_shl(T, x, y) ((x)<<((y)&(T)((sizeof(T)<<3)-1)))
#define mag_opf_shr(T, x, y) ((x)>>((y)&(T)((sizeof(T)<<3)-1)))
...
mag_gen_stub_binop(uint8_t, uint8, mod, mag_opf_mod, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int8_t, int8, mod, mag_opf_mod, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(uint16_t, uint16, mod, mag_opf_mod, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int16_t, int16, mod, mag_opf_mod, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(uint32_t, uint32, mod, mag_opf_mod, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int32_t, int32, mod, mag_opf_mod, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(uint64_t, uint64, mod, mag_opf_mod, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int64_t, int64, mod, mag_opf_mod, mag_cvt_nop, mag_cvt_nop)
...
mag_gen_stub_binop(int8_t, int8, shl, mag_opf_shl, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(uint16_t, uint16, shl, mag_opf_shl, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int16_t, int16, shl, mag_opf_shl, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(uint32_t, uint32, shl, mag_opf_shl, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int32_t, int32, shl, mag_opf_shl, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(uint64_t, uint64, shl, mag_opf_shl, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int64_t, int64, shl, mag_opf_shl, mag_cvt_nop, mag_cvt_nop)

mag_gen_stub_binop(uint8_t, uint8, shr, mag_opf_shr, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int8_t, int8, shr, mag_opf_shr, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(uint16_t, uint16, shr, mag_opf_shr, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int16_t, int16, shr, mag_opf_shr, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(uint32_t, uint32, shr, mag_opf_shr, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int32_t, int32, shr, mag_opf_shr, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(uint64_t, uint64, shr, mag_opf_shr, mag_cvt_nop, mag_cvt_nop)
mag_gen_stub_binop(int64_t, int64, shr, mag_opf_shr, mag_cvt_nop, mag_cvt_nop)
