...
#define MAG_ENV_READAHEAD "MAG_READ_AHEAD"                                /* Mapped snapshot readahead engine: 0, 1, or auto (only when the file exceeds 3/4 of RAM) */
...
extern MAG_COLDPROC MAG_EXPORT int mag_envcfg_readahead(void);
