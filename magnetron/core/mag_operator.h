...
typedef enum mag_opflags_t {
  ...
  */
  ...
  /* Pure pointwise operation whose execution may be deferred into a graph. A backend may still
     execute it eagerly if no exact fused lowering exists. */
  MAG_OP_FLAG_FUSE_DEFERABLE = 1<<3,
} mag_opflags_t;

#define MAG_OP_FLAGS_COMMON (MAG_OP_FLAG_SUPPORTS_INPLACE+MAG_OP_FLAG_SUPPORT_CPU_MULTITHREADING)
#define MAG_OP_FLAGS_DEFERABLE_OUT (MAG_OP_FLAG_SUPPORT_CPU_MULTITHREADING+MAG_OP_FLAG_FUSE_DEFERABLE)
#define MAG_OP_FLAGS_DEFERABLE (MAG_OP_FLAGS_COMMON+MAG_OP_FLAG_FUSE_DEFERABLE)
#define MAG_OP_FLAGS_FUSIBLE (MAG_OP_FLAGS_DEFERABLE+MAG_OP_FLAG_FUSIBLE)
...
#define mag_opdef(_, __)\
  ...
  _(CLONE, 1, 1, ALL, MAG_OP_FLAGS_DEFERABLE_OUT, clone)__\
  _(CAST, 1, 1, ALL, MAG_OP_FLAGS_DEFERABLE_OUT, cast)__\
  ...
  _(LOG, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, log)__\
  _(LOG10, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, log10)__\
  _(LOG1P, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, log1p)__\
  _(LOG2, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, log2)__\
  _(SQR, 1, 1, NUMERIC, MAG_OP_FLAGS_FUSIBLE, sqr)__\
  _(RCP, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, rcp)__\
  _(SQRT, 1, 1, FP, MAG_OP_FLAGS_FUSIBLE, sqrt)__\
  _(RSQRT, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, rsqrt)__\
  _(SIN, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, sin)__\
  _(COS, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, cos)__\
  _(TAN, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, tan)__\
  _(SINH, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, sinh)__\
  _(COSH, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, cosh)__\
  _(TANH, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, tanh)__\
  _(ASIN, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, asin)__\
  _(ACOS, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, acos)__\
  _(ATAN, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, atan)__\
  _(ASINH, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, asinh)__\
  _(ACOSH, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, acosh)__\
  _(ATANH, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, atanh)__\
  _(STEP, 1, 1, FP, MAG_OP_FLAGS_FUSIBLE, NULL)__\
  _(ERF, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, erf)__\
  _(ERFC, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, erfc)__\
  _(EXP, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, exp)__\
  _(EXP2, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, exp2)__\
  _(EXPM1, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, expm1)__\
  ...
  _(SIGMOID, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, sigmoid)__\
  _(SIGMOID_DV, 1, 1, FP, MAG_OP_FLAGS_COMMON, NULL)__\
  _(HARD_SIGMOID, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, hard_sigmoid)__\
  _(SILU, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, silu)__\
  ...
  _(GELU, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, gelu)__\
  _(GELU_APPROX, 1, 1, FP, MAG_OP_FLAGS_DEFERABLE, gelu)__\
  ...
  _(FLOORDIV, 2, 1, NUMERIC, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(MOD, 2, 1, NUMERIC, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(POW, 2, 1, NUMERIC, MAG_OP_FLAGS_DEFERABLE, pow)__\
  ...
  _(AND, 2, 1, INTEGRAL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(OR, 2, 1, INTEGRAL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(XOR, 2, 1, INTEGRAL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(NOT, 1, 1, INTEGRAL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(SHL, 2, 1, INTEGRAL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(SHR, 2, 1, INTEGRAL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(EQ, 2, 1, ALL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(NE, 2, 1, ALL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(LE, 2, 1, ALL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(GE, 2, 1, ALL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(LT, 2, 1, ALL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(GT, 2, 1, ALL, MAG_OP_FLAGS_DEFERABLE, NULL)__\
  _(WHERE, 3, 1, ALL, MAG_OP_FLAGS_DEFERABLE, where)__\
