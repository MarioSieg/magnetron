...
impl_unary_operator_test_group(0.f, log10, e8m23, [](auto x) { return std::log10(x); })
impl_unary_operator_test_group(0.f, log10, e5m10, [](auto x) { return std::log10(x); })
impl_unary_operator_test_group(0.f, log1p, e8m23, [](auto x) { return std::log1p(x); })
impl_unary_operator_test_group(0.f, log1p, e5m10, [](auto x) { return std::log1p(x); })
impl_unary_operator_test_group(0.f, log2, e8m23, [](auto x) { return std::log2(x); })
impl_unary_operator_test_group(0.f, log2, e5m10, [](auto x) { return std::log2(x); })
...
impl_unary_operator_test_group(0.f, tan, e8m23, [](auto x) { return std::tan(x); })
impl_unary_operator_test_group(0.f, tan, e5m10, [](auto x) { return std::tan(x); })
impl_unary_operator_test_group(0.f, sinh, e8m23, [](auto x) { return std::sinh(x); })
impl_unary_operator_test_group(0.f, sinh, e5m10, [](auto x) { return std::sinh(x); })
impl_unary_operator_test_group(0.f, cosh, e8m23, [](auto x) { return std::cosh(x); })
impl_unary_operator_test_group(0.f, cosh, e5m10, [](auto x) { return std::cosh(x); })
...
impl_unary_operator_test_group(0.f, asin, e8m23, [](auto x) { return std::asin(x); })
impl_unary_operator_test_group(0.f, asin, e5m10, [](auto x) { return std::asin(x); })
impl_unary_operator_test_group(0.f, acos, e8m23, [](auto x) { return std::acos(x); })
impl_unary_operator_test_group(0.f, acos, e5m10, [](auto x) { return std::acos(x); })
impl_unary_operator_test_group(0.f, atan, e8m23, [](auto x) { return std::atan(x); })
impl_unary_operator_test_group(0.f, atan, e5m10, [](auto x) { return std::atan(x); })
impl_unary_operator_test_group(0.f, asinh, e8m23, [](auto x) { return std::asinh(x); })
impl_unary_operator_test_group(0.f, asinh, e5m10, [](auto x) { return std::asinh(x); })
impl_unary_operator_test_group(0.f, acosh, e8m23, [](auto x) { return std::acosh(x); })
impl_unary_operator_test_group(0.f, acosh, e5m10, [](auto x) { return std::acosh(x); })
impl_unary_operator_test_group(0.f, atanh, e8m23, [](auto x) { return std::atanh(x); })
impl_unary_operator_test_group(0.f, atanh, e5m10, [](auto x) { return std::atanh(x); })
...
impl_unary_operator_test_group(0.f, erf, e8m23, [](auto x) { return std::erf(x); })
impl_unary_operator_test_group(0.f, erf, e5m10, [](auto x) { return std::erf(x); })
impl_unary_operator_test_group(0.f, erfc, e8m23, [](auto x) { return std::erfc(x); })
impl_unary_operator_test_group(0.f, erfc, e5m10, [](auto x) { return std::erfc(x); })
...
impl_unary_operator_test_group(0.f, exp2, e8m23, [](auto x) { return std::exp2(x); })
impl_unary_operator_test_group(0.f, exp2, e5m10, [](auto x) { return std::exp2(x); })
impl_unary_operator_test_group(0.f, expm1, e8m23, [](auto x) { return std::expm1(x); })
impl_unary_operator_test_group(0.f, expm1, e5m10, [](auto x) { return std::expm1(x); })
...
impl_unary_operator_test_group(0.f, round, e8m23, [](auto x) { return std::round(x); })
impl_unary_operator_test_group(0.f, round, e5m10, [](auto x) { return std::round(x); })
impl_unary_operator_test_group(0.f, trunc, e8m23, [](auto x) { return std::trunc(x); })
impl_unary_operator_test_group(0.f, trunc, e5m10, [](auto x) { return std::trunc(x); })
