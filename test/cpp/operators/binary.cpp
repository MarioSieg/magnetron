...
impl_binary_operator_test_group(add, +, NO_OP_B, e8m23, float)
impl_binary_operator_test_group(add, +, NO_OP_B, e5m10, float16)
...
impl_binary_operator_test_group(sub, -, NO_OP_B, e8m23, float)
impl_binary_operator_test_group(sub, -, NO_OP_B, e5m10, float16)
...
impl_binary_operator_test_group(mul, *, NO_OP_B, e8m23, float)
impl_binary_operator_test_group(mul, *, NO_OP_B, e5m10, float16)
...
impl_binary_operator_test_group(div, /, NO_OP_B, e8m23, float)
impl_binary_operator_test_group(div, /, NO_OP_B, e5m10, float16)
