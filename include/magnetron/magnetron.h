...
extern MAG_EXPORT mag_status_t mag_interpolate(mag_error_t *err, mag_tensor_t **out_result, mag_tensor_t *x, const int64_t *out_size, int64_t out_len, const double *scale_factor, const char *mode, bool align_corners, bool antialias);
