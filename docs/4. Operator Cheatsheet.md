...
> All operations here are methods on `Tensor`.  
> For each `x.op()`, there is usually an in-place `x.op_()` variant with the same semantics but modifying `x` in-place.

| Method        | Category         | Description                                  | Math (per element)                     | Example                |
|--------------|------------------|----------------------------------------------|----------------------------------------|------------------------|
| `abs()`      | Math             | Absolute value                               | $y = \vert x  \vert$                   | `y = x.abs()`              |
| `sgn()`      | Math             | Sign of each element                         | $y = \mathrm{sign}(x)$                 | `y = x.sgn()`          |
| `neg()`      | Math             | Negation                                     | $y = -x$                               | `y = x.neg()`          |
| `sqr()`      | Math             | Square                                       | $y = x^2$                              | `y = x.sqr()`          |
| `rcp()`      | Math             | Reciprocal                                   | $y = \frac{1}{x}$                      | `y = x.rcp()`          |
| `sqrt()`     | Math             | Square root                                  | $y = \sqrt{x}$                         | `y = x.sqrt()`         |
| `rsqrt()`    | Math             | Inverse square root                          | $y = \frac{1}{\sqrt{x}}$               | `y = x.rsqrt()`        |
| `log()`      | Math             | Natural logarithm                            | $y = \ln(x)$                           | `y = x.log()`          |
| `log2()`     | Math             | Base-2 logarithm                             | $y = \log_2(x)$                        | `y = x.log2()`         |
| `log10()`    | Math             | Base-10 logarithm                            | $y = \log_{10}(x)$                     | `y = x.log10()`        |
| `log1p()`    | Math             | Log of (1 + x)                               | $y = \ln(1 + x)$                       | `y = x.log1p()`        |
| `exp()`      | Math             | Exponential                                  | $y = e^x$                              | `y = x.exp()`          |
| `exp2()`     | Math             | Power of 2                                   | $y = 2^x$                              | `y = x.exp2()`         |
| `expm1()`    | Math             | Exponential minus 1                          | $y = e^x - 1$                          | `y = x.expm1()`        |
| `floor()`    | Rounding         | Round down                                   | $y = \lfloor x \rfloor$                | `y = x.floor()`        |
| `ceil()`     | Rounding         | Round up                                     | $y = \lceil x \rceil$                  | `y = x.ceil()`         |
| `round()`    | Rounding         | Round to nearest integer                     | $y = \mathrm{round}(x)$                | `y = x.round()`        |
| `trunc()`    | Rounding         | Truncate fractional part                     | $y = \mathrm{trunc}(x)$                | `y = x.trunc()`        |
| `sin()`      | Trig             | Sine                                         | $y = \sin(x)$                          | `y = x.sin()`          |
| `cos()`      | Trig             | Cosine                                       | $y = \cos(x)$                          | `y = x.cos()`          |
| `tan()`      | Trig             | Tangent                                      | $y = \tan(x)$                          | `y = x.tan()`          |
| `asin()`     | Trig             | Inverse sine                                 | $y = \arcsin(x)$                       | `y = x.asin()`         |
| `acos()`     | Trig             | Inverse cosine                               | $y = \arccos(x)$                       | `y = x.acos()`         |
| `atan()`     | Trig             | Inverse tangent                              | $y = \arctan(x)$                       | `y = x.atan()`         |
| `sinh()`     | Hyperbolic       | Hyperbolic sine                              | $y = \sinh(x)$                         | `y = x.sinh()`         |
| `cosh()`     | Hyperbolic       | Hyperbolic cosine                            | $y = \cosh(x)$                         | `y = x.cosh()`         |
| `tanh()`     | Hyperbolic       | Hyperbolic tangent                           | $y = \tanh(x)$                         | `y = x.tanh()`         |
| `asinh()`    | Hyperbolic       | Inverse hyperbolic sine                      | $y = \mathrm{asinh}(x)$                | `y = x.asinh()`        |
| `acosh()`    | Hyperbolic       | Inverse hyperbolic cosine                    | $y = \mathrm{acosh}(x)$                | `y = x.acosh()`        |
| `atanh()`    | Hyperbolic       | Inverse hyperbolic tangent                   | $y = \mathrm{atanh}(x)$                | `y = x.atanh()`        |
| `step()`     | Activation       | Heaviside step (0/1)                         | $y = \mathbb{1}[x > 0]$                | `y = x.step()`         |
| `erf()`      | Special          | Error function                               | $y = \mathrm{erf}(x)$                  | `y = x.erf()`          |
| `erfc()`     | Special          | Complementary error function                 | $y = \mathrm{erfc}(x)$                 | `y = x.erfc()`         |
| `softmax()`  | Activation       | Softmax over last dim                        | $y_i = \frac{e^{x_i}}{\sum_j e^{x_j}}$ | `y = x.softmax()`      |
| `sigmoid()`  | Activation       | Logistic sigmoid                             | $y = \frac{1}{1 + e^{-x}}$             | `y = x.sigmoid()`      |
| `hard_sigmoid()` | Activation   | Piecewise linear sigmoid                     | approx. sigmoid, clipped linear        | `y = x.hard_sigmoid()` |
| `silu()`     | Activation       | SiLU / Swish                                 | $y = x \cdot \sigma(x)$                | `y = x.silu()`         |
| `relu()`     | Activation       | Rectified Linear Unit                        | $y = \max(0,x)$                        | `y = x.relu()`         |
| `gelu()`     | Activation       | Exact GELU                                   | $y = x \cdot \Phi(x)$                  | `y = x.gelu()`         |
| `gelu_approx()` | Activation    | Fast approximate GELU                        | $y \approx 0.5x(1+\tanh(\cdots))$      | `y = x.gelu_approx()`  |
